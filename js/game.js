class Game{
                  ...
                  if (player.index !== null) {
                      ...
                      if(obstacleGroup.isTouching(players)){
                       // Escribe un código para asignar el valor de "gameState" a "End"
                            ...
                            gameState = "End"; // Cambia el gameState a "End"
                            player.update(); // Asegúrate de guardar el cambio de estado del jugador
    ...
    addObstacles() {       
        var x = Math.round(random(100, 900)); // Genera una posición x aleatoria
        var y = 0;
